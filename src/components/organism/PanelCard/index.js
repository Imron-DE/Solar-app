  ...
  return (
    <>
      <div class="flex flex-col items-center justify-center text-center bg-white py-16 px-4">
        <div class="flex flex-col-reverse sm:flex-row items-center justify-center gap-8">
          ...
          <Image src="https://shams.id/wp-content/uploads/2022/02/Image-21.png" alt="Panel Surya 1" className="w-40 h-40 sm:w-64 sm:h-64" width={100} height={100} />
        </div>
      </div>
    </>
  );
